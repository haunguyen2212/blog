...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin.home.index') }}">
        ...
        <div class="sidebar-brand-text mx-3">HTR Blog</div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Tùy chỉnh tài khoản:</h6>
                <a class="collapse-item" href="utilities-color.html">Tất cả tài khoản</a>
                <a class="collapse-item" href="utilities-border.html">Chờ xác nhận</a>
                <a class="collapse-item" href="utilities-border.html">Tạo tài khoản mới</a>
            </div>
        </div>
    </li>
